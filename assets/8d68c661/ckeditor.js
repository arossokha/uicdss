...
(function () {
    if (!window.CKEDITOR)window.CKEDITOR = (function () {
        var a = {timestamp:'97KD', version:'3.0', revision:'4148', _:{}, status:'unloaded', basePath:(function () {
    ...
    (function () {
        ...
        a.tools = {arrayCompare:function (f, g) {
            ...
            if (f == 'float')return 'cssFloat'; else return f.replace(/-./g, function (g) {
    ...
    d.event.prototype = {getKey:function () {
        ...
        if (g)if (h.stopPropagation)h.stopPropagation(); else h.cancelBubble = true;
    }, getTarget:function () {
    ...
    a.command = function (i, j) {
        ...
        e.extend(this, j, {modes:{wysiwyg:1}, state:2});
        a.event.call(this);
    };
    ...
    (function () {
        ...
        a.lang = {languages:{af:1, ar:1, bg:1, bn:1, bs:1, ca:1, cs:1, da:1, de:1, el:1, 'en-au':1, 'en-ca':1, 'en-uk':1, en:1, eo:1, es:1, et:1, eu:1, fa:1, fi:1, fo:1, 'fr-ca':1, fr:1, gl:1, gu:1, he:1, hi:1, hr:1, hu:1, is:1, it:1, ja:1, km:1, ko:1, lt:1, lv:1, mn:1, ms:1, nb:1, nl:1, no:1, pl:1, 'pt-br':1, pt:1, ro:1, ru:1, sk:1, sl:1, 'sr-latn':1, sr:1, sv:1, th:1, tr:1, uk:1, vi:1, 'zh-cn':1, zh:1}, load:function (k, l, m) {
            ...
            var l = this.languages, m = (navigator.userLanguage || navigator.language).toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), n = m[1], o = m[2];
            if (l[n + '-' + o])n = n + '-' + o; else if (!l[n])n = null;
            a.lang.detect = n ? function () {
                return n;
            } : function (p) {
                return p;
            };
    ...
    a.ui = function (k) {
        if (k.ui)return k.ui;
        this._ = {handlers:{}, items:{}};
        return this;
    };
    var k = a.ui;
    k.prototype = {add:function (l, m, n) {
        this._.items[l] = {type:m, args:Array.prototype.slice.call(arguments, 2)};
    }, create:function (l) {
        var m = this._.items[l], n = m && this._.handlers[m.type];
    ...
    (function () {
        var l = {colgroup:1, dd:1, dt:1, li:1, option:1, p:1, td:1, tfoot:1, th:1, thead:1, tr:1}, m = e.extend({table:1, ul:1, ol:1, dl:1}, f.table, f.ul, f.ol, f.dl);
        a.htmlParser.fragment.fromHtml = function (n, o) {
            var p = new a.htmlParser(), q = [], r = new a.htmlParser.fragment(), s = [], t = r, u = false, v;

            function w(A) {
                if (s.length > 0)for (var B = 0; B < s.length; B++) {
                    var C = s[B], D = C.name, E = f[D], F = t.name && f[t.name];
            ...
            function x(A, B, C) {
                ...
                if (o && !B.type) {
                    var D, E;
                    if (A.attributes && (E = A.attributes._cke_real_element_type))D = E; else D = A.name;
                    if (!(D in f.$body)) {
                        var F = t;
                        t = B;
                        p.onTagOpen(o, {});
            ...
            p.onTagOpen = function (A, B, C) {
                ...
                if (f.$removeEmpty[A]) {
                    s.push(D);
                    return;
                } else if (A == 'pre')u = true; else if (A == 'br' && u) {
                    t.add(new a.htmlParser.text('\n'));
                    return;
                }
                var E = t.name, F = E && f[E] || (t._.isBlockLike ? f.div : f.span);
                if (!D.isUnknown && !t.isUnknown && !F[A]) {
                    if (!E)return;
                    var G = false;
                    if (A == E)x(t, t.parent); else {
                        if (m[E]) {
                            if (!v)v = t;
                        } else {
                            x(t, t.parent, true);
        ...
        a.htmlParser.fragment.prototype = {add:function (n) {
            var q = this;
            var o = q.children.length, p = o > 0 && q.children[o - 1] || null;
            if (p) {
    ...
    (function () {
        ...
        d.range.prototype = {clone:function () {
            ...
            q = s.endContainer;
            r = s.endOffset;
            if (q.type != 1)if (!r)s.setEndBefore(q); else if (r >= q.getLength())s.setEndAfter(q);
    ...
    (function () {
        function l(m, n, o, p, q, r, s) {
            ...
            m.ui.addRichCombo(n, {label:p.label, title:p.panelTitle, voiceLabel:p.voiceLabel, className:'cke_' + (o == 'size' ? 'fontSize' : 'font'), multiSelect:false, panel:{css:[t.contentsCss, a.getUrl(m.skinPath + 'editor.css')], voiceLabel:p.panelVoiceLabel}, init:function () {
    ...
    j.add('format', {requires:['richcombo', 'styles'], init:function (l) {
        ...
        l.ui.addRichCombo('Format', {label:n.label, title:n.panelTitle, voiceLabel:n.voiceLabel, className:'cke_format', multiSelect:false, panel:{css:[m.contentsCss, a.getUrl(l.skinPath + 'editor.css')], voiceLabel:n.panelVoiceLabel}, init:function () {
    ...
    (function () {
        ...
        function n(L, M) {
            var N = L.children, O = N[N.length - 1];
            if (O) {
        ...
        function p(L) {
            n(L, true);
            if (o(L))if (c)L.add(new a.htmlParser.text('\xa0')); else L.add(new a.htmlParser.element('br', {}));
        }
        ...
        ;
        var r = f, s = e.extend({}, r.$block, r.$listItem, r.$tableContent);
        for (var t in s)if (!('br' in r[t]))delete s[t];
        delete s.pre;
        var u = {attributeNames:[
            [/^on/, '_cke_pa_on']
        ]}, v = {elements:{}};
        ...
        var w = {elementNames:[
            ...
            var M = L.parent;
            if (M && M.name == 'object') {
                var N = M.attributes.width, O = M.attributes.height;
        ...
        ;
        var A = /<(style)(?=[ >])[^>]*>[^<]*<\/\1>/gi, B = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, C = /(<\/?)((?:object|embed|param).*?>)/gi, D = /<cke:param(.*?)\/>/gi;
        ...
        ;
        function K(L, M) {
            var N = [], O = /<\!--\{cke_temp\}(\d*?)-->/g, P = [/<!--[\s\S]*?-->/g, /<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(M);
        ...
        ;
        j.add('htmldataprocessor', {requires:['htmlwriter'], init:function (L) {
        ...
        a.htmlDataProcessor.prototype = {toHtml:function (L, M) {
            ...
            if (c)L = J(L);
            var O = a.htmlParser.fragment.fromHtml(L, M), P = new a.htmlParser.basicWriter();
            O.writeHtml(P, this.dataFilter);
            return P.getHtml(true);
        }, toDataFormat:function (L, M) {
            var N = this.writer, O = a.htmlParser.fragment.fromHtml(L, M);
            N.reset();
    ...
    (function () {
        ...
        j.add('maximize', {init:function (q) {
            ...
            q.addCommand('maximize', {modes:{wysiwyg:1, source:1}, exec:function () {
                var I = this;
                ...
                if (I.state == 2) {
                    ...
                    z.setStyles({left:-1 * E.x + 'px', top:-1 * E.y + 'px'});
                ...
                if (q.mode == 'wysiwyg') {
                    ...
                    if (H)H.scrollIntoView(true); else t.$.scrollTo(v.x, v.y);
                } else {
                    if (u) {
    ...
    (function () {
        j.add('stylescombo', {requires:['richcombo', 'styles'], init:function (o) {
            ...
            o.ui.addRichCombo('Styles', {label:q.label, title:q.panelTitle, voiceLabel:q.voiceLabel, className:'cke_styles', multiSelect:true, panel:{css:[p.contentsCss, a.getUrl(o.skinPath + 'editor.css')], voiceLabel:q.panelVoiceLabel}, init:function () {
                var t = this, u = p.stylesCombo_stylesSet.split(':', 2), v = u[1] || a.getUrl(r + 'styles/' + u[0] + '.js');
                u = u[0];
    ...
    (function () {
        ...
        function o(q) {
            if (this.mode == 'wysiwyg') {
                ...
                var r = q.data, s = r.getName(), t = f.$block[s], u = this.getSelection(), v = u.getRanges(), w = u.isLocked;
                if (w)u.unlock();
                var x, y, z, A;
        ...
        ;
        function p(q) {
            var r = q.editor, s = q.data.path, t = s.blockLimit, u = q.data.selection, v = u.getRanges()[0], w = r.document.getBody(), x = r.config.enterMode;
            if (x != 2 && v.collapsed && t.getName() == 'body' && !s.block) {
                var y = u.createBookmarks(), z = v.fixBlock(true, r.config.enterMode == 3 ? 'div' : 'p');
                if (c) {
                    var A = z.getElementsByTag('br'), B;
                    for (var C = 0; C < A.count(); C++)if ((B = A.getItem(C)) && (B.hasAttribute('_cke_bogus')))B.remove();
                }
                u.selectBookmarks(y);
                var D = z.getChildren(), E = D.count(), F, G = d.walker.whitespaces(true), H = z.getPrevious(G), I = z.getNext(G), J;
                if (H && H.getName && !(H.getName() in l))J = H; else if (I && I.getName && !(I.getName() in l))J = I;
        ...
        ;
        j.add('wysiwygarea', {requires:['editingblock'], init:function (q) {
            var r = q.config.enterMode != 2 ? q.config.enterMode == 3 ? 'div' : 'p' : false;
            q.on('editingBlockReady', function () {
                var s, t, u, v, w, x, y, z = b.isCustomDomain(), A = function () {
                    if (u)u.remove();
                    if (t)t.remove();
                    x = 0;
                    ...
                    if (b.gecko) {
                        ...
                        s.setAttributes({role:'region', title:E});
                        u.setAttributes({role:'region', title:' '});
                    } else if (b.webkit) {
                    ...
                    if (!c)s.append(u);
                }, B = '<script id="cke_actscrpt" type="text/javascript">window.onload = function(){window.parent.CKEDITOR._["contentDomReady' + q.name + '"]( window );' + '}' + '</script>', C = function (D) {
                    if (x)return;
                    x = 1;
                    var E = D.document, F = E.body, G = E.getElementById('cke_actscrpt');
                    ...
                    if (b.gecko && H && H.is && H.is('br') && H.hasAttribute('_moz_editor_bogus_node')) {
                        ...
                        if (q.config.enterMode == 2)E.createElement('br', {attributes:{_moz_dirty:''}}).replace(J); else J.remove();
                    }
                ...
                q.addMode('wysiwyg', {load:function (D, E, F) {
                    s = D;
                    if (c && b.quirks)D.setStyle('position', 'relative');
                    q.mayBeDirty = true;
                    y = true;
                    if (F)this.loadSnapshotData(E); else this.loadData(E);
                }, loadData:function (D) {
                    v = true;
    ...
    (function () {
        ...
        function m() {
            var N = this;
            var J = N._.currentTabId, K = N._.tabIdList.length, L = e.indexOf(N._.tabIdList, J) + K;
        ...
        function n() {
            var N = this;
            var J = N._.currentTabId, K = N._.tabIdList.length, L = e.indexOf(N._.tabIdList, J);
            for (var M = L + 1; M < L + K; M++)if (l.call(N, N._.tabIdList[M % K]))return N._.tabIdList[M % K];
            return null;
        }
        ...
        a.dialog = function (J, K) {
            ...
            L = e.clone(L);
            L = new u(this, L);
            this.definition = L = a.fire('dialogDefinition', {name:K, definition:L}, J).definition;
            var M = a.document, N = J.theme.buildDialog(J);
            this._ = {editor:J, element:N.element, name:K, contentSize:{width:0, height:0}, size:{width:0, height:0}, updateSize:false, contents:{}, buttons:{}, accessKeyMap:{}, tabs:{}, tabIdList:[], currentTabId:null, currentTabIndex:null, pageCount:0, lastTab:null, tabBarMode:false, focusList:[], currentFocusIndex:0, hasFocus:false};
            this.parts = N.parts;
            ...
            var O = this, P = function (X) {
                var Y = O._.contents, Z = false;
            ...
            function R(X) {
                ...
                var Y = X.data.getKeystroke(), Z = false;
                if (Y == 9 || Y == 2000 + 9) {
                    var aa = Y == 2000 + 9;
                    if (O._.tabBarMode) {
            ...
            this.on('show', function () {
                ...
                if (!aa._.hasFocus) {
                    ...
                    if (aa._.editor.mode == 'wysiwyg' && c) {
                        var X = J.document.$.selection, Y = X.createRange();
            ...
            if (b.ie6Compat)this.on('load', function (X) {
                var Y = this.getElement(), Z = Y.getFirst();
                Z.remove();
                Z.appendTo(Y);
            }, this);
            w(this);
            ...
            var T = /cke_dialog_tab(\s|$|_)/, U = /cke_dialog_tab(\s|$)/;
            this.parts.tabs.on('click', function (X) {
                var ac = this;
                var Y = X.data.getTarget(), Z = Y, aa, ab;
            ...
            var V = [], W = a.dialog._.uiElementBuilders.hbox.build(this, {type:'hbox', className:'cke_dialog_footer_buttons', widths:[], children:L.buttons}, V).getChild();
        ...
        function p(J, K, L) {
            ...
            K.on('keydown', function (M) {
                if (M.data.getKeystroke() in {32:1, 13:1})this.fire('click');
            });
            K.on('focus', function () {
                this.fire('mouseover');
            });
        ...
        a.dialog.prototype = {resize:(function () {
            return function (J, K) {
                ...
                a.dialog.fire('resize', {dialog:L, skin:L._.editor.skinName, width:J, height:K}, L._.editor);
                L._.contentSize = {width:J, height:K};
                L._.updateSize = true;
            };
        })(), getSize:function () {
            var L = this;
            if (!L._.updateSize)return L._.size;
            var J = L._.element.getFirst(), K = L._.size = {width:J.$.offsetWidth || 0, height:J.$.offsetHeight || 0};
            ...
            return function (K, L) {
                ...
                O._.position = {x:K, y:L};
                if (!J) {
                    var N = a.document.getWindow().getScrollPosition();
                    K += N.x;
                    L += N.y;
                }
                M.setStyles({left:(K > 0 ? K : 0) + ('px'), top:(L > 0 ? L : 0) + ('px')});
            };
        })(), getPosition:function () {
            return e.extend({}, this._.position);
        }, show:function () {
            if (this._.editor.mode == 'wysiwyg' && c)this._.editor.getSelection().lock();
            var J = this._.element, K = this.definition;
            if (!(J.getParent() && J.getParent().equals(a.document.getBody())))J.appendTo(a.document.getBody()); else return;
            ...
            e.setTimeout(function () {
                var N = a.document.getWindow().getViewPaneSize(), O = this.getSize();
            ...
            var T = this;
            var K = [], L = J.label ? ' title="' + e.htmlEncode(J.label) + '"' : '', M = J.elements, N = a.dialog._.uiElementBuilders.vbox.build(T, {type:'vbox', className:'cke_dialog_page_contents', children:J.elements, expand:!!J.expand, padding:J.padding, style:J.style || 'width: 100%; height: 100%;'}, K), O = h.createFromHtml(K.join('')), P = h.createFromHtml(['<a class="cke_dialog_tab"', T._.pageCount > 0 ? ' cke_last' : 'cke_first', L, !!J.hidden ? ' style="display:none"' : '', ' id="', J.id + '_', e.getNextNumber(), '" href="javascript:void(0)"', ' hidefocus="true">', J.label, '</a>'].join(''));
            if (T._.pageCount === 0)T.parts.dialog.addClass('cke_single_page'); else T.parts.dialog.removeClass('cke_single_page');
            T._.tabs[J.id] = [P, O];
            T._.tabIdList.push(J.id);
            T._.pageCount++;
            T._.lastTab = P;
            var Q = T._.contents[J.id] = {}, R, S = N.getChild();
            while (R = S.shift()) {
                Q[R.id] = R;
            ...
            for (var K in O._.tabs) {
                var L = O._.tabs[K][0], M = O._.tabs[K][1];
                if (K != J) {
        ...
        e.extend(a.dialog, {add:function (J, K) {
            ...
            var J = function (K, L) {
                L = L || {};
                return e.extend({id:'ok', type:'button', label:K.lang.common.ok, 'class':'cke_dialog_ui_button_ok', onClick:function (M) {
                    var N = M.data.dialog;
                    if (N.fire('ok', {hide:true}).hide !== false)N.hide();
                }}, L, true);
            };
            J.type = 'button';
            ...
            var J = function (K, L) {
                L = L || {};
                return e.extend({id:'cancel', type:'button', label:K.lang.common.cancel, 'class':'cke_dialog_ui_button_cancel', onClick:function (M) {
                    var N = M.data.dialog;
                    if (N.fire('cancel', {hide:true}).hide !== false)N.hide();
                }}, L, true);
            };
            J.type = 'button';
            J.override = function (K) {
        ...
        var q = {resizable:0, minWidth:600, minHeight:400, buttons:[a.dialog.okButton, a.dialog.cancelButton]}, r = function (J, K, L) {
        ...
        u.prototype = {getContents:function (J) {
        ...
        function w(J) {
            var K = null, L = null, M = J.getElement().getFirst(), N = J.getParentEditor(), O = N.config.dialog_magnetDistance, P = o[N.skinName].margins || [0, 0, 0, 0];

            function Q(S) {
                var T = J.getSize(), U = a.document.getWindow().getViewPaneSize(), V = S.data.$.screenX, W = S.data.$.screenY, X = V - K.x, Y = W - K.y, Z, aa;
                K = {x:V, y:W};
                L.x += X;
                L.y += Y;
                if (L.x + P[3] < O)Z = -P[3]; else if (L.x - P[1] > U.width - T.width - O)Z = U.width - T.width + P[1]; else Z = L.x;
                if (L.y + P[0] < O)aa = -P[0]; else if (L.y - P[2] > U.height - T.height - O)aa = U.height - T.height + P[2]; else aa = L.y;
                J.move(Z, aa);
            ...
            J.parts.title.on('mousedown', function (S) {
                J._.updateSize = true;
                K = {x:S.data.$.screenX, y:S.data.$.screenY};
                a.document.on('mousemove', Q);
                a.document.on('mouseup', R);
                L = J.getPosition();
                if (b.ie6Compat) {
        ...
        ;
        function x(J) {
            var K = J.definition, L = K.minWidth || 0, M = K.minHeight || 0, N = K.resizable, O = o[J.getParentEditor().skinName].margins || [0, 0, 0, 0];
            ...
            ;
            var T = null, U = null, V = J._.editor.config.magnetDistance, W = ['tl', 't', 'tr', 'l', 'r', 'bl', 'b', 'br'];

            function X(aa) {
                var ab = aa.listenerData.part, ac = J.getSize();
                U = J.getPosition();
                e.extend(U, {x2:U.x + ac.width, y2:U.y + ac.height});
                T = {x:aa.data.$.screenX, y:aa.data.$.screenY};
                a.document.on('mousemove', Y, J, {part:ab});
                a.document.on('mouseup', Z, J, {part:ab});
                if (b.ie6Compat) {
                    var ad = z.getChild(0).getFrameDocument();
                    ad.on('mousemove', Y, J, {part:ab});
                    ad.on('mouseup', Z, J, {part:ab});
                }
            ...
            ;
            function Y(aa) {
                var ab = aa.data.$.screenX, ac = aa.data.$.screenY, ad = ab - T.x, ae = ac - T.y, af = a.document.getWindow().getViewPaneSize(), ag = aa.listenerData.part;
                ...
                T = {x:ab, y:ac};
                var ah, ai, aj, ak;
                if (U.x + O[3] < V)ah = -O[3]; else if (ag.search('l') != -1 && U.x2 - U.x < L + V)ah = U.x2 - L; else ah = U.x;
                if (U.y + O[0] < V)ai = -O[0]; else if (ag.search('t') != -1 && U.y2 - U.y < M + V)ai = U.y2 - M; else ai = U.y;
                if (U.x2 - O[1] > af.width - V)aj = af.width + O[1]; else if (ag.search('r') != -1 && U.x2 - U.x < L + V)aj = U.x + L; else aj = U.x2;
                if (U.y2 - O[2] > af.height - V)ak = af.height + O[2]; else if (ag.search('b') != -1 && U.y2 - U.y < M + V)ak = U.y + M; else ak = U.y2;
                J.move(ah, ai);
        ...
        var y, z, A = function (J) {
            ...
            var N = z, O = function () {
                ...
                N.setStyles({width:R.width + 'px', height:R.height + 'px'});
            }, P = function () {
                var R = K.getScrollPosition(), S = a.dialog._.currentTop;
                N.setStyles({left:R.x + 'px', top:R.y + 'px'});
                do {
                    var T = S.getPosition();
                    S.move(T.x, T.y);
            ...
            var K = J.data.$.ctrlKey || J.data.$.metaKey, L = J.data.$.altKey, M = J.data.$.shiftKey, N = String.fromCharCode(J.data.$.keyCode), O = C[(K ? 'CTRL+' : '') + (L ? 'ALT+' : '') + (M ? 'SHIFT+' : '') + N];
            ...
            var O = C[L] || (C[L] = []);
            O.push({uiElement:J, dialog:K, key:L, keyup:N || J.accessKeyUp, keydown:M || J.accessKeyDown});
        }, G = function (J) {
            for (var K in C) {
                var L = C[K];
        ...
        (function () {
            k.dialog = {uiElement:function (J, K, L, M, N, O, P) {
                if (arguments.length < 4)return;
                var Q = (M.call ? M(K) : M) || ('div'), R = ['<', Q, ' '], S = (N && N.call ? N(K) : N) || ({}), T = (O && O.call ? O(K) : O) || ({}), U = (P && P.call ? P(J, K) : P) || (''), V = this.domId = T.id || e.getNextNumber() + '_uiElement', W = this.id = K.id, X;
                T.id = V;
                var Y = {};
                ...
                if (arguments.length < 4)return;
                this._ || (this._ = {});
                var O = this._.children = K, P = N && N.widths || null, Q = N && N.height || null, R = {}, S, T = function () {
                    var U = ['<tbody><tr class="cke_dialog_ui_hbox">'];
                    for (S = 0; S < L.length; S++) {
                        var V = 'cke_dialog_ui_hbox_child', W = [];
                ...
                k.dialog.uiElement.call(this, J, N || {type:'hbox'}, M, 'table', R, N && N.align && {align:N.align} || null, T);
            }, vbox:function (J, K, L, M, N) {
                if (arguments.length < 3)return;
                this._ || (this._ = {});
                var O = this._.children = K, P = N && N.width || null, Q = N && N.heights || null, R = function () {
                    ...
                    for (var T = 0; T < L.length; T++) {
                        ...
                        if (Q)U.push('height:' + e.cssLength(Q[T])); else if (N && N.expand)U.push('height:' + Math.floor(100 / L.length) + '%');
                ...
                k.dialog.uiElement.call(this, J, N || {type:'vbox'}, M, 'div', null, null, R);
            }};
        })();
        k.dialog.uiElement.prototype = {getElement:function () {
            ...
            var K = /^on([A-Z]\w+)/, L, M = function (O, P, Q, R) {
                P.on('load', function () {
            ...
            for (var N in J) {
                ...
                if (this.eventProcessors[N])this.eventProcessors[N].call(this, this._.dialog, J[N]); else M(this, this._.dialog, L[1].toLowerCase(), J[N]);
            }
            return this;
        }, eventProcessors:{onLoad:function (J, K) {
            J.on('load', K, this);
        }, onShow:function (J, K) {
            J.on('show', K, this);
        }, onHide:function (J, K) {
        ...
        k.dialog.hbox.prototype = e.extend(new k.dialog.uiElement(), {getChild:function (J) {
            var K = this;
            if (arguments.length < 1)return K._.children.concat();
            if (!J.splice)J = [J];
            if (J.length < 2)return K._.children[J[0]]; else return K._.children[J[0]] && K._.children[J[0]].getChild ? K._.children[J[0]].getChild(J.slice(1, J.length)) : null;
        }}, true);
        k.dialog.vbox.prototype = new k.dialog.hbox();
        (function () {
            var J = {build:function (K, L, M) {
                var N = L.children, O, P = [], Q = [];
        ...
        a.dialogCommand.prototype = {exec:function (J) {
        ...
        (function () {
            ...
            a.dialog.validate = {functions:function () {
                return function () {
                    var S = this;
                    var M = S && S.getValue ? S.getValue() : arguments[0], N = undefined, O = 2, P = [], Q;
                    for (Q = 0; Q < arguments.length; Q++)if (typeof arguments[Q] == 'function')P.push(arguments[Q]); else break;
                    ...
                    for (Q = 0; Q < P.length; Q++)if (O == 2)R = R && P[Q](M); else R = R || P[Q](M);
                    if (!R) {
                ...
                return function () {
                    ...
                    if (!M.test(O)) {
                        if (N !== undefined)alert(N);
                        if (P && (P.select || P.focus))if (P.select)P.select(); else P.focus();
                        return false;
                    }
                    return true;
                };
    ...
    k.panel.block = e.createClass({$:function (l) {
        this.element = l.append(l.getDocument().createElement('div', {attributes:{'class':'cke_panel_block'}, styles:{display:'none'}}));
        this.keys = {};
        this._.focusIndex = -1;
    ...
    (function () {
        ...
        e.extend(k.dialog, {labeledElement:function (s, t, u, v) {
            ...
            var w = function () {
                ...
                var x = c && document.domain != window.location.hostname, y = ['<iframe frameborder="0" allowtransparency="0" class="cke_dialog_ui_input_file" id="', v.frameId, '" title="', t.label, '" src="javascript:void('];
    ...
    a.skins.add('kama', (function () {
        ...
        return{preload:l, editor:{css:['editor.css']}, dialog:{css:['dialog.css']}, templates:{css:['templates.css']}, margins:[0, 0, 0, 0], init:function (m) {
            ...
            function o(q) {
                if (!n)return null;
                var r = n.append('style'), s = '/* UI Color Support */.cke_skin_kama .cke_menuitem .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuitem a:hover .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a:focus .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a:active .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuitem a:hover .cke_label,.cke_skin_kama .cke_menuitem a:focus .cke_label,.cke_skin_kama .cke_menuitem a:active .cke_label{\tbackground-color: $color !important;}.cke_skin_kama .cke_menuitem a.cke_disabled:hover .cke_label,.cke_skin_kama .cke_menuitem a.cke_disabled:focus .cke_label,.cke_skin_kama .cke_menuitem a.cke_disabled:active .cke_label{\tbackground-color: transparent !important;}.cke_skin_kama .cke_menuitem a.cke_disabled:hover .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a.cke_disabled:focus .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a.cke_disabled:active .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuitem a.cke_disabled .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuseparator{\tbackground-color: $color !important;}.cke_skin_kama .cke_menuitem a:hover,.cke_skin_kama .cke_menuitem a:focus,.cke_skin_kama .cke_menuitem a:active{\tbackground-color: $color !important;}';
                ...
                return(o = function (v) {
                    if (b.webkit)for (var w in s)r.$.sheet.addRule(s[w][0], s[w][1].replace(t, v)); else {
                        var x = s.replace(t, v);
                        if (c)r.$.styleSheet.cssText = x; else r.setHtml(x);
                    }
                })(q);
            }
            ...
            e.extend(m, {uiColor:null, getUiColor:function () {
                ...
                var r = a.document.getHead().append('style'), s = '#cke_' + m.name.replace('.', '\\.'), t = [s + ' .cke_wrapper', s + '_dialog .cke_dialog_contents', s + '_dialog a.cke_dialog_tab', s + '_dialog .cke_dialog_footer'].join(','), u = 'background-color: $color !important;';
                r.setAttribute('type', 'text/css');
                return(this.setUiColor = function (v) {
                    var w = u.replace('$color', v);
                    m.uiColor = v;
                    if (c)r.$.styleSheet.cssText = t + '{' + w + '}'; else if (b.webkit)r.$.sheet.addRule(t, w); else r.setHtml(t + '{' + w + '}');
                    o(v);
                })(q);
            }});
            if (a.menu) {
