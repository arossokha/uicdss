...
<div id="table" class="info four2 type3">
	<table>
		<tr>
			...
			<td class="left">
				<?php
				echo CHtml::link(' ', '/user/view/' . $data->primaryKey, array('target' => '_blank', 'class' => 'hiddenLink'));
				?>
				<span><?php 
					if(strlen($data->info) > 140) {
						echo mb_substr($data->info, 0, 140).'...';
					}else{
